...
<body id="page-top" style="background: linear-gradient(45deg, #49a09d, #5f2c82)">

    <!-- Page Wrapper -->
    <div id="wrapper" >

        <!-- Sidebar -->
        <ul class="navbar-nav sidebar accordion text-white" id="accordionSidebar" style="background: linear-gradient(45deg, #49a09d, #5f2c82) ">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse text-light " aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="py-2 collapse-inner rounded" style=" background: linear-gradient(45deg, #49a09d, #5f2c82)">
                        ...
                        <a class="collapse-item text-light" href="buttons.html">Control</a>
                        <a class="collapse-item text-light" href="cards.html">Set Timer</a>
                    </div>
                </div>
            </li>
            ...
            <div class="text-center d-none d-md-inline">
                <button class="rounded-circle border-0" id="sidebarToggle" style="background: linear-gradient(45deg, #49a09d, #5f2c82) "></button>
            </div>
        ...
        <!-- Content Wrapper -->
        <div id="content-wrapper" class="d-flex flex-column" style="background: linear-gradient(45deg, #49a09d, #5f2c82)">

            <!-- Main Content -->
            <div id="content">

                <!-- Topbar -->
                <nav class="navbar navbar-expand bg-white topbar mb-4 static-top shadow" style="background: linear-gradient(45deg, #49a09d, #5f2c82) ">
                ...
                <div class="container-fluid" >
                    ...
                    <div class="text-center" >
                        <div class="error mx-auto text-light" data-text="404">404</div>
                        <p class="lead text-light mb-5">Page Not Found</p>
                        <p class="text-gray-500 mb-0">It looks like you found a glitch in the matrix...</p>
                        <a class="text-light" href="dashboard.html">&larr; Back to Dashboard</a>
                    </div>
