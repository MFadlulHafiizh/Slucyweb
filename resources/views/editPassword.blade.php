        ...
        <div class="card o-hidden border-0 shadow-lg my-5 w-100" style="overflow: auto ; background: linear-gradient(45deg, #49a09d, #5f2c82)">
            <div class="card-body w-100">
                <div class="text-center">
                    <h1 class="h4 text-light mt-3 mb-4">Change your password</h1>
                </div>
                <form class="user" runat="server" action="{{ route('updatePassword') }}" method="POST">
                    @method('PUT')
                     @csrf

                    <div class="form-group">
                        <div class="col-sm-12 mb-3 mb-sm-0">
                            <label for="exampleFirstName" class="ml-3 text-white">Current Password : </label>
                        </div>
                        <div class="col-sm-12 mb-3 mb-sm-0">
                            <input type="password" name="current_password" class="form-control form-control-user @error('current_password') is-invalid @enderror" id="exampleFirstName" required
                    ...
                    <div class="form-group">
                        <div class="col-sm-12 mb-3 mb-sm-0">
                            <label for="exampleFirstName" class="ml-3 text-white">New Password : </label>
                        </div>
                        <div class="col-sm-12 mb-3 mb-sm-0">
                        <input type="password" name="new_password" class="form-control form-control-user  @error('password') is-invalid @enderror" id="exampleInputEmail" required
